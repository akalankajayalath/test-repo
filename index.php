      ...
      <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="hp_banner_box">
          <div class="hp_banner_left">
            ...
            <div class="fs_news_left_img_g"> <img src=<?=$value['news_cover_img'];?> alt="" width="900" height="auto" />
                    ...
                    <div class="fs_news_left fs_gadgets_news_left">
                      ...
                      foreach ($second_news as $key => $value) {
                        if($value['news_id']%2==0){
                          if($i==0){?>
                          <div class="fs_news_left_img_g"> <img src="<?=$value['news_cover_img'];?>" alt="" />
                      ...
                      <div class="single_fs_news_left_text">
                       ...
                       <div class="all_news_right">
                        <div class="fs_news_right">
                          <div class="single_fs_news_img"> <img src="<?=$value['news_cover_img'];?>" alt="" /> </div>
        ...
        <div class="home_sidebar">
          <div class="follow_us_side">
            ...
            <div class="all_single_follow">
              <div class="single_follow_us"> <a href="https://www.facebook.com/CNONE-100557934667029/"> <i class="fa fa-facebook"></i><br>
                665<br>
                Fans </a> </div>
