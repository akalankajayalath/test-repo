		...
		<div class="container">
							...
							<div id="carousel-example-genericbs" class="carousel slide" data-ride="carousel">
							  ...
							  <div class="carousel-inner" role="listbox">
								<div class="item active">
								  <?php echo '<img src="news_imges/local_news_img/'.$news_value["news_title_img"].'" alt="blog single post" />';?>
								</div>
            ...
            $i=5;
                ...
                <div class="fs_news_right">
                  <div class="single_fs_news_img"><img src="news_imges/local_news_img/<?=$valuees['news_hover_img'];?>" alt="" /></div>
