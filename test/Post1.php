...
$news=new News_model;
$value=$news->get_news_byId($news_id);
...
?>
  <head>
    ...
    <title>Hash | Blog slider Post Page</title>
							...
							<div id="carousel-example-genericbs" class="carousel slide" data-ride="carousel">
							  ...
							  <div class="carousel-inner" role="listbox">
								<div class="item active">
								  <?php echo '<img src="news_imges/local_news_img/'.$value["news_title_img"].'" alt="blog single post" />';?>
								</div>
						...
						<div class="sp_details">
							...
							<div class="social_tags">
								...
								<div class="social_tags_right">
									<ul>
										<li class="facebook"><a class="fa fa-facebook" href="https://web.facebook.com/ONE-youtube-1st-1981796675367769/" target="_blank"></a></li>
